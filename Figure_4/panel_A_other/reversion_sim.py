...
if __name__ == '__main__':
    ...
    numpy.savetxt('small_bottleneck_mutations.txt', save1)
    numpy.savetxt('small_bottleneck_reversions.txt', save2)
    numpy.savetxt('small_bottleneck_hitch.txt', save3)
