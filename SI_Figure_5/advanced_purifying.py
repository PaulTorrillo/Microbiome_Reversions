...
if __name__ == '__main__':
    ...
    for zed in range(1):
        ...
        for u in range(numberofruns):
            ...
            for k in range(numbergens):
                ...
                if numpy.random.uniform(0,1)<((1/(8400))):
    ...
    numpy.savetxt('neutralmutations.txt', save1)
    numpy.savetxt('neutralreversions.txt', save2)
    numpy.savetxt('neutralhitch.txt', save3)
