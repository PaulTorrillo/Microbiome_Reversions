...
for genus in genus_list:
    ...
    if numpy.sort(combined_genus_data[:,0])[9] < 0.0005:
        ...
        axs[1].errorbar(iteration_counter, (optimal_params[0]/optimal_params[2]) , yerr=[[lower_error2], [upper_error2]], fmt='o', capsize=3)
        findingmedianT.append(optimal_params[0]/optimal_params[2])
...
axs[1].set_ylim([-300, 3300])
axs[1].set_ylabel('T$_{adapt}$', rotation='vertical', size=10)
