...
#This version runs faster and takes the average of more to control for the higher variance from correlating transmissions and adaptations.
...
if __name__ == '__main__':
        ...
        for u in range(numberofruns):
            ...
            for k in range(numbergens):
                ...
                if numpy.random.uniform(0,1)<bottleneckprob:
                    ...
                    numbertoadd = numpy.random.poisson(11.9047, 1)
    ...
    numpy.savetxt('moresmaller_correlatemutations.txt', save1)
    numpy.savetxt('moresmaller_correlatereversions.txt', save2)
    numpy.savetxt('moresmall_correlatehitch.txt', save3)
